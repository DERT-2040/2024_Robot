...
## Generated on : Fri Jan 26 20:27:07 2024
...
PRODUCT_NAME              = Code_Gen_Model
MAKEFILE                  = Code_Gen_Model.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/USER/Documents/2024_Robot-Imported/src/main
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Code_Gen_Model_comp.rsp
CMD_FILE                  = Code_Gen_Model.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Code_Gen_Model.exe
...
DEFINES_STANDARD = -DMODEL=Code_Gen_Model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/Code_Gen_Model_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Code_Gen_Model_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Code_Gen_Model_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Code_Gen_Model_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Code_Gen_Model_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Code_Gen_Model.obj : $(START_DIR)/Code_Gen_Model_ert_rtw/Code_Gen_Model.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Code_Gen_Model_data.obj : $(START_DIR)/Code_Gen_Model_ert_rtw/Code_Gen_Model_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rtGetNaN.obj : $(START_DIR)/Code_Gen_Model_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"
