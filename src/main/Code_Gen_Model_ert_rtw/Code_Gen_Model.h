...
typedef struct {
  ...
  real_T BR_Desired_Wheel_Speed_in;    /* '<S364>/Switch1' */
  real_T FL_Desired_Wheel_Speed_in;    /* '<S349>/Switch1' */
  real_T FR_Desired_Wheel_Speed_in;    /* '<S354>/Switch1' */
  real_T BL_Desired_Wheel_Speed_in;    /* '<S359>/Switch1' */
  ...
  real_T Meas_Back_AA_Length;          /* '<S127>/Sqrt' */
  real_T Front_Arm_Length;             /* '<S21>/Subtract1' */
  real_T Meas_Front_AA_Length;         /* '<S131>/Sqrt' */
...
typedef struct {
  ...
  real_T UnitDelay1_DSTATE;            /* '<S341>/Unit Delay1' */
  ...
  real_T UnitDelay1_DSTATE_i;          /* '<S314>/Unit Delay1' */
  ...
  boolean_T DelayInput1_DSTATE_o1;     /* '<S148>/Delay Input1' */
  ...
  boolean_T UnitDelay2_DSTATE;         /* '<S370>/Unit Delay2' */
 ...
 * '<S27>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero1'
 * '<S28>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero10'
 ...
 * '<S36>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero2'
 * '<S37>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero3'
 * '<S38>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero4'
 * '<S39>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero5'
 * '<S40>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero6'
 * '<S41>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero7'
 * '<S42>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero8'
 * '<S43>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero9'
 * '<S44>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Detect Increase'
 * '<S45>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/GameState is Test'
