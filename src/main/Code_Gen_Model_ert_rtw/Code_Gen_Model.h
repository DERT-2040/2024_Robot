...
typedef struct {
  ...
  real_T Desired_Back_Lower_Dist;      /* '<S168>/Sum' */
  real_T Desired_Front_Dist;           /* '<S167>/Sum' */
...
typedef struct {
  ...
  real_T UnitDelay1_DSTATE_j;          /* '<S177>/Unit Delay1' */
  real_T UD_DSTATE_ii;                 /* '<S176>/UD' */
  ...
  real_T FixPtUnitDelay1_DSTATE_f2;    /* '<S410>/FixPt Unit Delay1' */
  ...
  uint8_T FixPtUnitDelay2_DSTATE_k;    /* '<S175>/FixPt Unit Delay2' */
  uint8_T FixPtUnitDelay2_DSTATE_e;    /* '<S173>/FixPt Unit Delay2' */
  uint8_T FixPtUnitDelay2_DSTATE_j;    /* '<S171>/FixPt Unit Delay2' */
  uint8_T FixPtUnitDelay2_DSTATE_jk;   /* '<S186>/FixPt Unit Delay2' */
  ...
  boolean_T DelayInput1_DSTATE_hg;     /* '<S178>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_p;      /* '<S180>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_o1;     /* '<S182>/Delay Input1' */
 ...
 * '<S153>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits'
 ...
 * '<S166>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Rate Limit Ball Screw'
 * '<S167>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits/Discrete Rate Limiter'
 * '<S168>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits/Discrete Rate Limiter1'
 * '<S169>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits/Discrete Rate Limiter2'
 * '<S170>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits/Discrete Rate Limiter/Saturation Dynamic'
 * '<S171>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits/Discrete Rate Limiter/Unit Delay External IC'
 * '<S172>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits/Discrete Rate Limiter1/Saturation Dynamic'
 * '<S173>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits/Discrete Rate Limiter1/Unit Delay External IC'
 * '<S174>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits/Discrete Rate Limiter2/Saturation Dynamic'
 * '<S175>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/Arms_Rate_Limits/Discrete Rate Limiter2/Unit Delay External IC'
 * '<S176>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/PD3/Difference'
 * '<S177>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/PD3/Low_Pass_Filter'
 * '<S178>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/PI and Integral Enable/Detect Increase'
 * '<S179>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/PI and Integral Enable/Saturation Dynamic'
 * '<S180>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/PI and Integral Enable1/Detect Increase'
 * '<S181>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/PI and Integral Enable1/Saturation Dynamic'
 * '<S182>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/PI and Integral Enable2/Detect Increase'
 * '<S183>' : 'Code_Gen_Model/RoboRio Controls/Shooter_Arm_Controls/PI and Integral Enable2/Saturation Dynamic'
