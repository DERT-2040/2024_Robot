...
typedef struct {
  ...
  boolean_T Shooter_Control_Type;      /* '<S5>/Chart_Intake_and_Shooter' */
} B_Code_Gen_Model_T;
...
typedef struct {
  ...
  real_T UnitDelay1_DSTATE_kd;         /* '<S19>/Unit Delay1' */
  real_T UD_DSTATE_av;                 /* '<S18>/UD' */
  real_T UnitDelay_DSTATE_fl;          /* '<S16>/Unit Delay' */
  real_T UnitDelay1_DSTATE_p;          /* '<S22>/Unit Delay1' */
  real_T UD_DSTATE_k1;                 /* '<S21>/UD' */
  real_T UnitDelay_DSTATE_mv;          /* '<S17>/Unit Delay' */
 ...
 * '<S16>'  : 'Code_Gen_Model/RoboRio Controls/Intake_and_Shooter/Feed Forward plus PID'
 * '<S17>'  : 'Code_Gen_Model/RoboRio Controls/Intake_and_Shooter/Feed Forward plus PID1'
 * '<S18>'  : 'Code_Gen_Model/RoboRio Controls/Intake_and_Shooter/Feed Forward plus PID/Difference'
 * '<S19>'  : 'Code_Gen_Model/RoboRio Controls/Intake_and_Shooter/Feed Forward plus PID/Low_Pass_Filter'
 * '<S20>'  : 'Code_Gen_Model/RoboRio Controls/Intake_and_Shooter/Feed Forward plus PID/Saturation Dynamic'
 * '<S21>'  : 'Code_Gen_Model/RoboRio Controls/Intake_and_Shooter/Feed Forward plus PID1/Difference'
 * '<S22>'  : 'Code_Gen_Model/RoboRio Controls/Intake_and_Shooter/Feed Forward plus PID1/Low_Pass_Filter'
 * '<S23>'  : 'Code_Gen_Model/RoboRio Controls/Intake_and_Shooter/Feed Forward plus PID1/Saturation Dynamic'
