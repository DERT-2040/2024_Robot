...
typedef struct {
  ...
  boolean_T Shooter_Brake_Enable_out;  /* '<S8>/Chart_Intake_and_Shooter' */
...
typedef struct {
  ...
  real_T UD_DSTATE_j;                  /* '<S136>/UD' */
  real_T UD_DSTATE_m;                  /* '<S137>/UD' */
  real_T UD_DSTATE_ic;                 /* '<S138>/UD' */
  real_T UD_DSTATE_ce;                 /* '<S139>/UD' */
