...
const ConstB_Code_Gen_Model_T Code_Gen_Model_ConstB = {
  ...
  -0.78539816339744828,                /* '<S317>/Atan1' */
  0.78539816339744828,                 /* '<S317>/Add1' */
  2.3561944901923448,                  /* '<S317>/Atan3' */
  3.9269908169872414,                  /* '<S317>/Add2' */
  -2.3561944901923448,                 /* '<S317>/Atan4' */
  -0.78539816339744828                 /* '<S317>/Add3' */
};
