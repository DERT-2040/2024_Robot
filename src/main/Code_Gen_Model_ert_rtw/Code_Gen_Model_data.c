...
const ConstB_Code_Gen_Model_T Code_Gen_Model_ConstB = {
  ...
  -1.0,                                /* '<S302>/Cos5' */
  1.2246467991473532E-16,              /* '<S302>/Sin5' */
  -1.0,                                /* '<S323>/Cos5' */
  1.2246467991473532E-16,              /* '<S323>/Sin5' */
  -0.78539816339744828,                /* '<S333>/Atan1' */
  0.78539816339744828,                 /* '<S333>/Add1' */
  2.3561944901923448,                  /* '<S333>/Atan3' */
  3.9269908169872414,                  /* '<S333>/Add2' */
  -2.3561944901923448,                 /* '<S333>/Atan4' */
  -0.78539816339744828                 /* '<S333>/Add3' */
};
