...
const ConstB_Code_Gen_Model_T Code_Gen_Model_ConstB = {
  645.16,                              /* '<S128>/Math Function1' */
  645.16,                              /* '<S131>/Math Function1' */
  645.16,                              /* '<S132>/Math Function1' */
  -1.0,                                /* '<S245>/Cos5' */
  1.2246467991473532E-16,              /* '<S245>/Sin5' */
  -1.0,                                /* '<S266>/Cos5' */
  1.2246467991473532E-16,              /* '<S266>/Sin5' */
  -1.0,                                /* '<S287>/Cos5' */
  1.2246467991473532E-16,              /* '<S287>/Sin5' */
  -1.0,                                /* '<S308>/Cos5' */
  1.2246467991473532E-16,              /* '<S308>/Sin5' */
  -0.6251674791193863,                 /* '<S318>/Atan1' */
  0.94562884767551025,                 /* '<S318>/Add1' */
  2.5164251744704069,                  /* '<S318>/Atan3' */
  4.0872215012653035,                  /* '<S318>/Add2' */
  -2.5164251744704069,                 /* '<S318>/Atan4' */
  -0.94562884767551036                 /* '<S318>/Add3' */
};
