...
const ConstB_Code_Gen_Model_T Code_Gen_Model_ConstB = {
  ...
  645.16,                              /* '<S147>/Math Function1' */
  645.16,                              /* '<S148>/Math Function1' */
  -1.0,                                /* '<S261>/Cos5' */
  1.2246467991473532E-16,              /* '<S261>/Sin5' */
  -1.0,                                /* '<S282>/Cos5' */
  1.2246467991473532E-16,              /* '<S282>/Sin5' */
  -1.0,                                /* '<S303>/Cos5' */
  1.2246467991473532E-16,              /* '<S303>/Sin5' */
  -1.0,                                /* '<S324>/Cos5' */
  1.2246467991473532E-16,              /* '<S324>/Sin5' */
  -0.78539816339744828,                /* '<S334>/Atan1' */
  0.78539816339744828,                 /* '<S334>/Add1' */
  2.3561944901923448,                  /* '<S334>/Atan3' */
  3.9269908169872414,                  /* '<S334>/Add2' */
  -2.3561944901923448,                 /* '<S334>/Atan4' */
  -0.78539816339744828                 /* '<S334>/Add3' */
};
