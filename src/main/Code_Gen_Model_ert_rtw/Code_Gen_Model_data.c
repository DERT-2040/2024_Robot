...
const ConstB_Code_Gen_Model_T Code_Gen_Model_ConstB = {
  ...
  -1.0,                                /* '<S306>/Cos5' */
  1.2246467991473532E-16,              /* '<S306>/Sin5' */
  -0.6251674791193863,                 /* '<S316>/Atan1' */
  0.94562884767551025,                 /* '<S316>/Add1' */
  2.5164251744704069,                  /* '<S316>/Atan3' */
  4.0872215012653035,                  /* '<S316>/Add2' */
  -2.5164251744704069,                 /* '<S316>/Atan4' */
  -0.94562884767551036                 /* '<S316>/Add3' */
};
