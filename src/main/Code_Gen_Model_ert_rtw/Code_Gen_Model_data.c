...
const ConstB_Code_Gen_Model_T Code_Gen_Model_ConstB = {
  ...
  -0.6251674791193863,                 /* '<S322>/Atan1' */
  0.94562884767551025,                 /* '<S322>/Add1' */
  2.5164251744704069,                  /* '<S322>/Atan3' */
  4.0872215012653035,                  /* '<S322>/Add2' */
  -2.5164251744704069,                 /* '<S322>/Atan4' */
  -0.94562884767551036                 /* '<S322>/Add3' */
};
